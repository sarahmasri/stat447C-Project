...
\\
\\
\noindent {\bf Breat cancer data:}  Single cell RNA sequencing of primary breast cancer in homo sapiens. Project investiage's gene expression from 515 single cell sequencing data from 11 breast cancer patients.
